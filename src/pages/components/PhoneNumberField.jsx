...
const PhoneNumberField = ({
  ...
  return (
    <div className={`flex flex-col ${widthClass} mb-[26px] relative ${className}`}>
      ...
      <div className={`${isMobile ? 'border-[1px] border-[#11111333] rounded-[4px]' : "border-[2px] border-[#E8E8E9] rounded-[10px]"} bg-white py-[0px] h-[42px] px-[8px] flex items-center gap-[10px] focus-within:border focus-within:border-[#6C6AC7]`}>
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            <span className={`${isOpen ? "rotate-180" : ""} ml-2 duration-200`}>
        ...
        <input
          ...
          className="flex-1 h-[90%] bg-transparent outline-none text-[15px]/[20px] text-[#333] font-sans tracking-[0.2px] pr-2 focus:border-none"
          onInput={(event) => {
